...
@section('page_title')
    {{ __('admin::app.customers.notes.create-title') }}
@stop
...
@section('content')
    ...
    <div class="content">
        <form method="POST" action="{{ route('admin.customer.notes.store', $customer->id) }}">
            <div class="page-header">
                <div class="page-title">
                    <h1>
                        <i class="icon angle-left-icon back-link" onclick="window.location = '{{ route('admin.customer.notes.index', ['id' => $customer->id]) }}'"></i>

                        {{ __('admin::app.customers.notes.create-new-title', ['customer_name' => $customer->first_name . ' ' . $customer->last_name]) }}
                    </h1>
                </div>
            ...
            <div class="page-content">
                <div class="form-container">
                    ...
                    <div class="control-group" :class="[errors.has('channel_id') ? 'has-error' : '']">
                        ...
                        <textarea class="control" style="height: 300px" name="notes" v-pre rows="10"></textarea>
...
{{--    <div class="content">--}}
{{--        {!! view_render_event('admin.customer.notes.create.before') !!}--}}
