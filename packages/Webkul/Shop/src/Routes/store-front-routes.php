...
Route::group(['middleware' => ['web', 'locale', 'theme', 'currency']], function () {
     ...
     * Store front home.
     */
    Route::get('/', [HomeController::class, 'index'])->defaults('_config', ['view' => 'shop::home.index',])->name('shop.home.index');
//    Route::get('/', [\Webkul\Shop\Http\Controllers\OnepageController::class, 'saveOrder'])->name('shop.home.index');
