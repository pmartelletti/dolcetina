    ...
    */
    ...
    public function store()
    {
        $this->validate(request(), [
            ...
            'weight_from'           => 'required|decimal:4|min:0.0001',
            'weight_to'             => 'required|decimal:4|min:0.0001',
            'zip_from'              => 'required|string',
            'zip_to'                => 'required|string',
            'price'                 => 'required|decimal:4|min:0.0001',
...
//                    dd($shipping_rate);
//                    dd($shipping_rate->weight_from, $data['weight_from'],  $shipping_rate->weight_to, $data['weight_from']);
            ...
            foreach ($excelData as $tableRateData) {
                foreach ($tableRateData as $column => $data) {
                    ...
                    $validator = Validator::make($data, [
                        ...
                        'weight_from'   => 'required|decimal:4|min:0.0001',
                        'weight_to'     => 'required|decimal:4|min:0.0001',
                        'price'         => 'required|decimal:4|min:0',
                        'is_zip_range'  => 'sometimes',
                        'zip_code'      => 'nullable'
                    ]);
...
//                                        ($shipping_rate->weight_from <= $data['weight_to'] && $shipping_rate->weight_to <= $data['weight_to']) ||
                            ...
                            $failedRules[$column+1] = trans('tablerate::app.admin.shipping-rates.no-superset-exists', [
