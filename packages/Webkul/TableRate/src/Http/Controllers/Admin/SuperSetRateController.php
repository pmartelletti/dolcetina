...
class SuperSetRateController extends Controller
{
    ...
    */
    ...
    public function create()
    {
        ...
        return view($this->_config['view'], compact('superSets'));
    }
    ...
    public function store()
    {
        $this->validate(request(),[
            'price_from'            => 'required|decimal:4',
            'price_to'              => 'required|decimal:4',
    ...
    public function edit($id)
    {
        ...
        return view($this->_config['view'], compact('superSets', 'superSetRate'));
    }
