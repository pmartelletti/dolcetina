                        ...
                        <div slot="body">
                            ...
                            <div class="control-group" :class="[errors.has('is_zip_range') ? 'has-error' : '']">
                                ...
                                <select class="control" v-validate="'required'" id="is_zip_range" name="is_zip_range" data-vv-as="&quot;{{ __('tablerate::app.admin.shipping-rates.is_zip_range') }}&quot;">
                                    <option value="0" @if (old('is_zip_range') == 0) selected @endif>{{ __('tablerate::app.admin.shipping-rates.isrange-yes') }}</option>
                                    <option value="1" @if (old('is_zip_range') == 1) selected @endif>{{ __('tablerate::app.admin.shipping-rates.isrange-no') }}</option>
                                </select>
